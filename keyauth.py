...
def encerrormessage():
        ...
        print("")
        print(datetime.datetime.now().strftime(f"{Fore.LIGHTWHITE_EX}%H.%M | {colorxrs}Message{Fore.LIGHTWHITE_EX} | {errormsg}"))
        time.sleep(1.8)
        print(datetime.datetime.now().strftime(f"{Fore.LIGHTWHITE_EX}%H.%M | {colorxrs}Message{Fore.LIGHTWHITE_EX} | Press enter to exit."))
        input()
        os._exit(0)
...
class api:
    ...
    def init(self):
        ...
        if json["message"] == "invalidver":
            if json["download"] != "":
                ...
                print(f"{Fore.LIGHTWHITE_EX}═══════════════════════════════════════════════════════════════════════════════════════════════")
                print("")
                print(datetime.datetime.now().strftime(f"{Fore.LIGHTWHITE_EX}%H.%M | {colorxrs}Update{Fore.LIGHTWHITE_EX} | Enconomy has a new Version."))
                time.sleep(1)
                print(datetime.datetime.now().strftime(f"{Fore.LIGHTWHITE_EX}%H.%M | {colorxrs}Update{Fore.LIGHTWHITE_EX} | You will be redirected to the download link."))
                time.sleep(1.5)
                ...
                errormsg = "Invalid Version, Contact owner to add download link."
                encerrormessage()
    ...
    def __do_request(self, post_data):
        try:
            ...
            errormsg = "Request timed out. Server is probably down."
            encerrormessage()
